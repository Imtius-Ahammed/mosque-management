...
const Header = () => {
    ...
    return (
        ...
        <Navbar className='d-print-none' collapseOnSelect sticky='top' expand="lg" bg="dark" variant="dark">
            <Container>
                ...
                <Navbar.Collapse className='text-dark' id="responsive-navbar-nav">
                    <Nav className="mx-auto ">
                        ...
                        <Nav.Link className='text-light' as={Link} to="update">UpdateExpert</Nav.Link>
